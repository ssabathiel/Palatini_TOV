...
#include "meta_functions.h"
    ...
    namespace constants{
        ...
        long double const ggrav = 6.673*pow(10,-8);          //Grav-Konstante: 6.67408 × 10-11 m3 kg-1 s-2
        double const G=ggrav;
        double const clight = 2.99792458*pow(10,10);    //Speed of light: 2,99*10^8 m/
        ...
        double const rho_center = 1.0*pow(10,12);       // rho_center and value if rho=const
        ...
        double const a =  0.5;
        double const kappa_2 = 8*pi*ggrav/pow(clight,2);
